...
public class NoteController : MonoBehaviour
{
    ...
    private string musicTitle;  //음악이름변수
    private string musicArtist;    //음악작곡가변수
    private int bpm;
    private int divider;
    ...
    IEnumerator AwaitMakeNote(Note note)
    {
        ...
        yield return new WaitForSeconds(startingPoint + order * beatInterval);  //startingpoint 이후에노드떨어짐
        MakeNote(note);
    }
    ...
    void Start()
    {
        ...
        //세 번째 줄에 적힌 비트 정보 (BPM, Divider, 시작시간 )을 읽습니다.
